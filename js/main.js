(function () {
  ...
  /* The editorial headline wraps naturally through responsive CSS. */
  var explore = document.querySelector('[data-explore-services]');
  if (explore) explore.addEventListener('click', function () {
    var trigger = document.querySelector('.rail .has-sub > a');
